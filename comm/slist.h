 ...
 */
#define slist_for_each_entry(element, list, member) \
        for (struct slist_head* __node__ = (list)->next;   \
             ((__node__ != NULL) && (element = list_entry(__node__, typeof(*element), member))); \
